...
int main(int argc, char* argv[]) {
    ...
    maxStackSize = numRow * numCol;
    stack = (element*)malloc(maxStackSize * sizeof(element));
    ...
    while (top > -1 && found == 0)
    {
        ...
        while (dir < 8 && found == 0)
        {
            ...
            else if (nextRow >= 0 && nextRow < numRow && nextCol >= 0 && nextCol < numCol && maze[nextRow][nextCol] == 0 && mark[nextRow][nextCol] == 0)
            {
